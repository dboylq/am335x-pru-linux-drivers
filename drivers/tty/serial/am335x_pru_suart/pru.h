...
***********************************************************/
// PRU Memory Macros
#define PRU0_DATA_RAM_START  (0x4a300000)
#define PRU0_PROG_RAM_START  (0x4a334000)

#define PRU1_DATA_RAM_START  (0x4a302000)
#define PRU1_PROG_RAM_START  (0x4a338000)

#define PRU_DATA_RAM_SIZE    (8192)
#define PRU_PROG_RAM_SIZE    (8192)

#define PRU_PRU0_BASE_ADDRESS					0
#define PRU_INTC_BASE_ADDRESS					(PRU_PRU0_BASE_ADDRESS + 0x20000)
